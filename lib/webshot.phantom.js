...
console.log('options.paperSize.header.contents='+JSON.stringify(options.paperSize.header.contents)
        if (typeof options.paperSize.header.contents === 'function') {
            options.paperSize.header.contents(pageNum, numPages);
        } else {
            return options.paperSize.header.contents;
        }
      })
    }
  ...
  if (key === "paperSize" && page[key] && page[key].footer && page[key].footer.contents) {
    var footer = {
      ...
      "contents": phantom.callback(function(pageNum, numPages) {
        return options.paperSize.footer.contents;
      })
    }
